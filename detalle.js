...
const propiedades = [
  ...
  },
  {
    ...
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/caldera/6/1.jpeg",
      "imagenes/propiedadesnelly/caldera/6/2.jpeg",
      "imagenes/propiedadesnelly/caldera/6/3.jpeg",
      "imagenes/propiedadesnelly/caldera/6/5.jpeg",
    ],
  ...
  },
  {
    ...
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/caldera/7/1.jpeg",
      "imagenes/propiedadesnelly/caldera/7/2.jpeg",
      "imagenes/propiedadesnelly/caldera/7/3.jpeg",
      "imagenes/propiedadesnelly/caldera/7/4.jpeg",
    ],
...

  {
    ...
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/copiapó/lomas de chamonate/opcion 2/2.2.png",
      "imagenes/propiedadesnelly/copiapó/lomas de chamonate/opcion 2/2.1.png",
    ],
    desc: "Terreno con vista inmejorable, ideal para casa de descanso.",
    ubicacion: "Bahía Inglesa",
    piezas: "N/A",
...

  {
    ...
    sector: "Copiapó",
    precio: "$120.000.000",
    imagenes: ["imagenes/propiedadesnelly/otros sectores/1/1.1.png"],
    desc: "Terreno con vista inmejorable, ideal para casa de descanso.",
    ubicacion: "Bahía Inglesa",
    piezas: "N/A",
    banos: "N/A",
  ...
  {
    id: 11,
    titulo: "Casa Valle Fertil N°11",
    tipo: "venta",
    sector: "Copiapó",
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/otros sectores/2 valle fertil/2.0.jpg",
      "imagenes/propiedadesnelly/otros sectores/2 valle fertil/2.1.jpg",
      "imagenes/propiedadesnelly/otros sectores/2 valle fertil/2.2.jpg",
      "imagenes/propiedadesnelly/otros sectores/2 valle fertil/2.3.jpg",
    ],
    desc: "Terreno con vista inmejorable, ideal para casa de descanso.",
    ubicacion: "Bahía Inglesa",
    piezas: "N/A",
  ...
  {
    id: 12,
    titulo: "Casa San Pedro N°12",
    tipo: "venta",
    sector: "Copiapó",
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/otros sectores/3 San Pedro casa azul/1.jpeg",
      "imagenes/propiedadesnelly/otros sectores/3 San Pedro casa azul/2.jpeg",
    ],
    desc: "Terreno con vista inmejorable, ideal para casa de descanso.",
    ubicacion: "Bahía Inglesa",
    piezas: "N/A",
  ...
  {
    id: 13,
    titulo: "Casa San Pedro N°13",
    tipo: "venta",
    sector: "Copiapó",
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/otros sectores/4 San Pedro parcela con 2 casas/1.jpeg",
      "imagenes/propiedadesnelly/otros sectores/4 San Pedro parcela con 2 casas/2.jpeg",
    ],
    desc: "Terreno con vista inmejorable, ideal para casa de descanso.",
    ubicacion: "Bahía Inglesa",
    piezas: "N/A",
...

  {
    ...
    precio: "$120.000.000",
    imagenes: [
      "imagenes/propiedadesnelly/bahía inglesa/1/terreno bahia 1.0.jpg",
      "imagenes/propiedadesnelly/bahía inglesa/1/terreno bahia 1.1.jpg",
    ],
    desc: "Terreno con vista inmejorable, ideal para casa de descanso.",
    ubicacion: "Bahía Inglesa",
    piezas: "N/A",
